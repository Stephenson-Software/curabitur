...
# the vendored client is client/src/trace_client.py (the server carries an identical copy)
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "client", "src"))

from trace_client import TraceClient, environment_opts_out  # noqa: E402
